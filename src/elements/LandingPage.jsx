    ...
    return (
        <div className="flex h-[90vh] justify-center items-center border-y-black-2">
            ...
            <div className="text-left font-sans">
                ...
                <h3 className="text-[20px]">Front End and IT Management Enthusias</h3>
                <div className="w-full mt-5">
                    <div className="flex mb-2"><AiOutlineInstagram className="text-[22px] mx-2" /><p>Instagram: <a href="https://www.instagram.com/abidmsn_/" className=" hover:font-semibold">abidmsn_</a></p></div>
                    ...
                    <div className="flex"><AiOutlineLinkedin className="text-[22px] mx-2"/><p>Linkedin: <a href="https://www.linkedin.com/in/abid-muhsin" className=" hover:font-semibold">Abid Muhsin</a></p></div>
                </div>
            </div>
        </div>
    )
